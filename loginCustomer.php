    ...
    if(mysqli_connect_error()){
        ...
        if(array_key_exists("phone", $_POST) AND array_key_exists("password", $_POST)){
            if($_POST["phone"]=="" OR $_POST["password"]==""){
                ...
                $query="SELECT * FROM customers WHERE phone='".$phoneEntered."'"." AND password='".$_POST['password']."'";
                ...
                if(mysqli_num_rows($result)>0){//USER EXISTS WITH GIVE EMAIL AND PASSWORD
                    ...
                    $_SESSION['customerGender']=$row['gender'];
    ...
    <section>
        <div class="login-box">
            <div class="form_c">
                ...
                <center><a href="registerCustomer.php">Register</a></center>         
            </div>
