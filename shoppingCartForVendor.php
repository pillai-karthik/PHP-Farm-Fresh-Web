            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><h5><strong>Rs.23000</strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                        <td>   </td>
                        <td><h5>Estimated shipping (Will implement afterwards)</h5></td>
                        <td class="text-right"><h5><strong>Rs.2400</strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                        <td>   </td>
                        <td><h3>Total</h3></td>
                        <td class="text-right"><h3><strong>Rs.25400</strong></h3></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
