    ...
    if(mysqli_connect_error()){
        ...
        if(array_key_exists("name", $_POST) AND array_key_exists("phone", $_POST) AND array_key_exists("password", $_POST) AND array_key_exists("cpassword", $_POST) AND array_key_exists("gender", $_POST)){
            ...
            if($_POST['phone']=="" OR $_POST['password']=="" OR $_POST['cpassword']=="" OR $_POST['name']=="" OR $_POST['gender']==""){
                ...
                $query="SELECT * FROM customers WHERE phone='".mysqli_real_escape_string($link,$_POST['phone'])."'";
                ...
                if(mysqli_num_rows($result)>0){
                    ...
                    $query="INSERT INTO customers (name,phone,password,gender) VALUES ('".ucwords($_POST['name'])."','".$phoneEntered."','".$_POST['password']."','".$_POST['gender']."')";//*********SQL PROTECTION REQUIRED*******
    ...
    <section>
        <div class="signup-box">
            <div class="form-c">
                ...
                <center><a href = "loginCustomer.php">Login</a></center>
            </div>
